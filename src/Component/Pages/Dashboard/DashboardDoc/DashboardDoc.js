...
const DashboardDoc = () => {
    ...
    useEffect(() => {
        fetch('https://limitless-thicket-29802.herokuapp.com/orders')
            .then(res => res.json())
            .then(data => {
    ...
    return (
        <div className="flex-1 flex  flex-col">
            <main className="flex-1 md:w-12/12 w-11/12 mx-auto  bg-gray-200">
                    ...
                    <div className="mt-4">
                        <div className="flex flex-wrap -mx-6">
                            ...
                            <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                                <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                    <div className="p-3 rounded-full bg-green-500 bg-orange-600 bg-opacity-75">
                                    ...
                                    <div className="mx-5">
                                        <h4 className="text-2xl font-semibold text-gray-700">{productsOrder?.length}</h4>
                            ...
                            <div
                                ...
                                <table className="min-w-full">
                                    <thead>
                                        <tr>
                                            <th
                                                ...
                                                Name</th>
                                            <th
                                                className="px-6 hidden sm:flex py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                Status</th>
                                            <th
                                                className=" px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                Role</th>
                                            <th
                                                className="px-3 sm:px-6 py-3  border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                                Edit</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody className="bg-white">
                                        {
                                            users.map(user => <DashboardTable user={user} key={user._id} />)
                                        }
